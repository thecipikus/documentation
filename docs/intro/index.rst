...
+=============================+============================+====================================================+
| Required technical skills   | None                       | Basic PHP knowledge *if used outside of WordPress* |
+-----------------------------+----------------------------+----------------------------------------------------+
| Upgrades and patches        | Automatic                  | Manual or Automatic [1]_                           |
+-----------------------------+----------------------------+----------------------------------------------------+
...
.. [1] The free version of TubePress can be auto-updated when used in WordPress 3.7 or higher.
